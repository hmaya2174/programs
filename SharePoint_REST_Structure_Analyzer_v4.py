...
def start_browser():
    ...
    print()
    print("IMPORTANT")
    print("Close ALL normal Microsoft Edge windows before continuing.")
    print("Edge locks the active profile while it is in use.")
    print()
    ...
    try:
        ...
        raise RuntimeError(
            "Could not launch Microsoft Edge with the existing profile.\n\n"
            "Close ALL Edge windows and background Edge processes, then retry.\n\n"
