#!/usr/bin/env python3
"""
TeamSite Procedure Complexity Classifier v1
...
def fetch_page(url: str) -> str:
    ...
    This relies on the workstation/network already allowing access to the URL.
    If your corporate environment requires Windows integrated authentication,
    requests may receive a login page or 401/403.  The error message will make
    that visible rather than silently classifying the wrong page.
    """
    headers = {
    ...
    if response.status_code in (401, 403):
        raise RuntimeError(
            ...
            "The Python process is not being accepted by the site's authentication."
        )
...
def main() -> int:
    ...
    try:
        ...
        print("The program intentionally does not disable certificate validation.")
        print(str(exc))
        return 2
